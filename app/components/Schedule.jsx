...
const Schedule = () => {
  return (
      <section className="w-full min-h-svh grid lg:grid-cols-2">
        <HalfBox className="bg-amber-700 bg-[url(/salon_portrait_4.webp)] bg-cover relative">
          <div className="absolute inset-0 bg-background opacity-90"></div>
          <div className="relative">
            <h2 className={`${Kugile.className} text-center text-3xl md:text-5xl mb-3.5 text-white`}>Book Your Appointment</h2>
            ...
            <Link href="https://wa.me/8025304967" className="flex items-center gap-2 bg-[#fff] py-4 px-7 rounded-full w-fit m-auto hover:bg-[#ff6ec3] group">
        ...
        <HalfBox className="bg-[#9b005a]">
          <h2 className={`${Kugile.className} text-center text-3xl md:text-5xl mb-3.5 text-white`}>Ready to turn your passion into a profession?</h2>
          ...
          <Link href="tel:+2348025304967" className="flex items-center gap-2 bg-[#F0EEE4] py-4 px-7 rounded-full w-fit m-auto hover:bg-background group">
            <img className="invert-100 group-hover:invert-0" src="/icons/register.svg" alt="" width={24} height={24} />
